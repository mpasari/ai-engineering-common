...
1. Not produce any output based on the flagged input
2. Log the detection event (agent ID, timestamp, data category detected —
...
- Synthetic email addresses using example domains (e.g. [test@example.com](mailto:test@example.com),
[user@test.internal](mailto:user@test.internal))
